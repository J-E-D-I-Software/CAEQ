...
const testPostCourse = async () => {
    ...
    let data = {
        ...
        temario: "- Generar modelos de análisis de diferentes sistemas estructurales...\n".repeat(5),
...
const testPostCourseWithIncorrectDates = async () => {
    ...
    expect(res.body.message).toEqual('La fecha fin debe de ir después de la fecha de inicio');
};
